...
const insert = async function (dados) {
    let sql = `INSERT INTO ${tabela} (nome,descricao,imagem, id_grupo, id_respiracao) VALUES ("${dados.nome}","${dados.descricao}","${dados.img}",${dados.idGrupo},${dados.idRespiracao});`
...
const update = async function (dados, id) {
    ...
    id_respiracao= ${dados.idRespiracao}
